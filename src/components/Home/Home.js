...
class Home extends Component {
	render () {
		let heading = "Soaring to new heights";
      	let subheading = "Lorem isum dolor sit amet, и немного рыбы на русском жфывдлаофжывлдрпшгукрщшпг.";
			        ...
			        <div className="container">
			          <div className="columns pd is-desktop">
			            ...
			            <div className="column is-one-third-desktop">
			              <p className="title"><strong>We provide superior logistis so that your business can succeed in a crazy world.</strong></p>
			            </div>
			            <div className="column">
			              <p>Lorem isum dolor sit amet, и немного рыбы на русском жфывдлаофжывлдрпшгукрщшпгLorem isum dolor sit amet.</p>
			            </div>
			          </div>
			        </div>
